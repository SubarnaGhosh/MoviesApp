package com.example.moviesjet.model
...
fun getMovies(): List<Movie> {
    return listOf(
        Movie(id = "tt0499549",
            ...
            plot = "On the lush alien world of Pandora live the Na'vi, beings who appear primitive but are highly evolved. Because the planet's environment is poisonous, human/Na'vi hybrids, called Avatars, must link to human minds to allow for free movement on Pandora.",
            poster = "https://images.wallpapersden.com/image/download/5k-avatar-the-way-of-water-poster_bW5lbWyUmZqaraWkpJRqZmdlrWdtbWU.jpg",
